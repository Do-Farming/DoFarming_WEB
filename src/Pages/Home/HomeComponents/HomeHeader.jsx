...
const HomeHeader = () => {
  ...
  const handleDivClick = (divNumber, imageUrl) => {
    setSelectedDiv(divNumber);
    setSelectedDivImage(imageUrl);
    closeModal();
  };
  ...
  return (
    <HomeHeaderWrap>
      <HomeHeaderContent>
        ...
        <MoodWrap>
          <Moodlets
            style={{ backgroundImage: `url(${selectedDivImage})` }}
            onClick={openModal}
          ></Moodlets>
        </MoodWrap>
      </HomeHeaderContent>
        ...
        <ModalOverlay onClick={closeModal}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <HimgWrap>
              <ImgWrap>
                <Div
                  onClick={() => handleDivClick("div1", "emotion1.PNG")}
                  style={{ backgroundImage: 'url("emotion1.PNG")'}}
                ></Div>
                <Div
                  onClick={() => handleDivClick("div2", "emotion2.PNG")}
                  style={{ backgroundImage: 'url("emotion2.PNG")' }}
                ></Div>
                <Div
                  onClick={() => handleDivClick("div3", "emotion3.PNG")}
                  style={{ backgroundImage: 'url("emotion3.PNG")' }}
                ></Div>
              </ImgWrap>
              <ImgWrap>
                <Div
                  onClick={() => handleDivClick("div4", "emotion4.PNG")}
                  style={{ backgroundImage: 'url("emotion4.PNG")' }}
                ></Div>
                <Div
                  onClick={() => handleDivClick("div5", "emotion5.PNG")}
                  style={{ backgroundImage: 'url("emotion5.PNG")' }}
                ></Div>
                <Div
                  onClick={() => handleDivClick("div6", "emotion6.PNG")}
                  style={{ backgroundImage: 'url("emotion6.PNG")' }}
                ></Div>
              </ImgWrap>
              <ImgWrap>
                <Div
                  onClick={() => handleDivClick("div7", "emotion7.PNG")}
                  style={{ backgroundImage: 'url("emotion7.PNG")' }}
                ></Div>
                <Div
                  onClick={() => handleDivClick("div8", "emotion8.PNG")}
                  style={{ backgroundImage: 'url("emotion8.PNG")' }}
                ></Div>
                <Div
                  onClick={() => handleDivClick("div9", "emotion9.PNG")}
                  style={{ backgroundImage: 'url("emotion9.PNG")' }}
                ></Div>
              </ImgWrap>
            </HimgWrap>
